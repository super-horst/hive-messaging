...
impl CertificateEncoding for GrpcCertificateEncoding {
    ...
    fn serialise(data: &hive_crypto::Certificate) -> Result<Vec<u8>, CryptoError> {
    ...
    fn decode_partial(serialised: common::Certificate) -> Result<(hive_crypto::Certificate, Option<common::Certificate>), CryptoError> {
