...
use hive_crypto::{CertificateEncoding, CertificateInfoBundle, CryptoError, FromBytes, PublicKey};
...
impl CertificateEncoding for GrpcCertificateEncoding {
    ...
    fn decode_partial(
        ...
        let cert =
            hive_crypto::Certificate::new(serialised.certificate, serialised.signature, cert_info);
